...
var warp = document.getElementById("container"),	w = window.innerWidth , h = window.innerHeight;
 ...
 function animm(elm){   
   TweenMax.to(elm,R(7,15),{y:h+100,ease:Linear.easeNone,repeat:-1,delay:2});
   TweenMax.to(elm,R(2,8),{x:'+=100',rotationZ:R(0,180),repeat:-1,yoyo:true,ease:Sine.easeInOut});
   TweenMax.to(elm,R(4,20),{rotationX:R(0,360),rotationY:R(0,360),repeat:-1,yoyo:true,ease:Sine.easeInOut,delay:5});
 };
